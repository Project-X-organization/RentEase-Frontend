...
const UploadImages = ({register, errors, setValue, clearErrors, getValues }) => {
    return (
        <div className="lg:px-12">
            ...
            <p className="lg:p-4 lg:px-8 mx-4 lg:mx-0 mt-8 p-2 text-red-500 bg-[#EFFFF4] lg:text-xl mb-12 text-center lg:text-left">Maximum of 5mb size per image type</p>
