    ...
    return (
        <div className="lg:px-12">
            <div className="flex items-center  lg:mb-8 lg:mt-16">
                ...
                <h2 className="text-2xl text-[#4F4FFF] font-bold">Upload Images</h2>
            </div>
            <p className="lg:p-4 lg:px-8 mx-4 lg:mx-0 mt-8 p-2 text-red-500 bg-blue-200 lg:text-xl mb-12 text-center lg:text-left">Maximum of 5mb size per image type</p>
