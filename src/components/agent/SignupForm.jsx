...
export default function SignupForm() {
  ...
  return (
    <div className="flex flex-col items-center bg-white h-[90%] w-full p-6 mt-5">
      <div className="bg-white shadow-md rounded-lg p-6 w-full h-full flex flex-col justify-center">
        <h2 className="text-5xl font-bold text-gray-700 text-center mb-4">Sign Up</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
          <div className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-blue-600 text-white rounded py-3 text-lg flex items-center justify-center gap-2 hover:bg-blue-700"
            >
