  ...
  import ReusableProfileSection from './ReusableProfileSection';
  ...
  const ProfilePage = () => {
    ...
    return (
      <FadeInSection type="slideDown" className="lg:w-[77%]"><div className="w-full pt-8 lg:py-16 lg:px-20 px-4 py-4">
        {/*<h1 className="lg:mb-16 mb-8 lg:text-xl ml-8 lg:ml-8 lg:mt-4">Welcome Back, <span className="font-semibold">Esther</span></h1>*/}
        <h1 className='font-semibold lg:text-xl lg:mb-8 mb-3'>My Profile</h1>
        <input
          type="file"
          accept="image/*"
        ...
        <FadeInSection type="slideRight" delay="1" className="flex bg-[#F9FCFF] lg:pr-8 py-4 justify-self end lg:pl-4 pl-2 lg:mb-6 mb-3">
