const FormContainer = ({children}) => {
    return (
        <div className="h-auto min-h-screen bg-[url('/form-bg.jfif')] bg-cover bg-center relative flex items-center">
            {/*Gray overlay */}
            ...
            <div className="relative z-10 w-full px-4 pb-4 lg:px-4 mx-auto lg:mx-0 lg:pb-8">
                ...
                <div className="bg-white lg:w-[60%] mx-auto  lg:px-16 lg:py-20 p-4">{children}</div>
            </div>
        </div>
    );
};
