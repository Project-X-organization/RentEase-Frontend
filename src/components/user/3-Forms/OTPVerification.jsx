...
const OTPVerification = ({ onVerify, email }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full ">
      <h2 className="text-3xl lg:text-4xl text-green-800 font-semibold mt-4">Verify Your Email</h2>
      ...
      <button
        ...
        className="mt-4 lg:px-6 p-2 lg:py-4 w-[65%] bg-green-600 text-white tlg:ext-lg rounded hover:bg-green-800 hover:scale-110"
      >
        Confirm Email
      </button>
    </div>
