      ...
      <div className="relative z-10 text-white text-center px-4 lg:px-4 w-[85%] mx-auto lg:mx-0 lg:w-[72%] lg:pb-8">
        <FadeInSection type="slideUp">
          ...
          <div className="flex justify-center lg:justify-start lg:mt-0 mt-12  lg:ml-12">
            <Link to="/signup" className="lg:mt-12 px-4 py-2 sm:px-6 sm:py-3 lg:px-8 lg:py-4 bg-white border border-white rounded-md text-sm sm:text-base lg:text-sm text-[#019208] font-bold hover:bg-green-200 hover:px-6 hover:py-4 lg:hover:px-12 lg:hover:py-6 transition-all duration-300">
              Get Started
            </Link>
          </div>
        </FadeInSection>
