  ...
  return (
    <>
      ...
      <nav className="absolute top-0 left-0 w-full bg-transparent z-20 p-4 pb-5 lg:px-16 lg:pt-12 flex justify-between items-center backdrop-blur-md lg:backdrop-blur-none">
        ...
        <div className="flex items-center text-white font-medium text-xl mx-auto lg:mx-0">
          <img src="/icon.png" alt="Logo" />
          <p className="ml-2 mt-4">MyCareTaker</p>
        </div>

        {/* Desktop Navigation */}
        <div className="hidden lg:flex gap-16 mt-2 text-green-200">
          <Link to="/" className="text-2xl text-green-400 hover:text-green-200 hover:scale-110">Home</Link>
          <Link to="/property" className="text-2xl text-green-400 hover:text-green-200 hover:scale-110">Property</Link>
          <Link to="/product" className="text-2xl text-green-400 hover:text-green-200 hover:scale-110">Product</Link>
          <Link to="/contact" className="text-2xl text-green-400 hover:text-green-200 hover:scale-110">Contact</Link>
        </div>
