...
const DeletedListings = () => {
    ...
    return (
        <div>
            <Navbar />
            <h1 className="font-bold lg:text-4xl my-4 lg:mt-4 lg:mb-0 lg:mx-12 mx-4 text-center lg:text-left">DELETED APARTMENTS</h1>
            <div className="w-full grid lg:grid-cols-2 gap-8 lg:my-12 mt-4 mb-12 text-red-500">
